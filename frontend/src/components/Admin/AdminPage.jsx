        ...
        <div className="z-50 w-full flex rounded-xl p-1 bg-[#13064f] top-0 px-2">
          <div className="w-10/12 rounded-sm flex">
            <input
              ...
              className="w-full bg-[#220d81] transparent text-2xl p-1 pl-2 text-left outline-none text-black"
              value={searchMentor}
              onChange={(e) => {
          ...
          <div className="bg-gray-800 flex w-2/12">
            <FaSearch className="w-full p-1 self-center text-black text-2xl" />
          </div>
        </div>
